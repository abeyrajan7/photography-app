...
;
const UploadMenu = ({ closeMenu, setLoadedImages, loadedImages, fetchImages })=>{
    ...
    const handleUpload = async ()=>{
        ...
        setUploading(true);
        try {
            // Upload logic here (e.g., sending to S3 or backend)
            // Call fetchImages to refresh the gallery
            await fetchImages();
...
//# sourceMappingURL=src_b00a9e._.js.map